...
//       .then(data => {
//         setRecipes(data);
//         filterRecipes(); // Assuming you call filterRecipes right after setting the recipes
//       })
...
//   useEffect(() => {
//     filterRecipes();
//   }, [dietaryRestrictions, budget, calories, goal]); // Dependency array includes all filters

//   const handleDietaryChange = (restriction) => {
//     if (dietaryRestrictions.includes(restriction)) {
//       setDietaryRestrictions(prev => prev.filter(item => item !== restriction));
//     } else {
...
//   const filterRecipes = () => {
//     fetch('http://localhost:5000/api/recipes') // Fetch or use a local source of recipes
//       .then(response => response.json())
//       .then(allRecipes => {
//         const filtered = allRecipes.filter(recipe => {
//           const meetsDietaryRestrictions = dietaryRestrictions.every(dr => recipe.tags.includes(dr));
//           const withinBudget = recipe.price >= 5 && recipe.price <= budget; // Assuming recipe has a price tag
//           const withinCalories = recipe.calories >= 100 && recipe.calories <= calories; // Assuming recipe has a calorie count
//           return meetsDietaryRestrictions && withinBudget && withinCalories;
//         });
//         setRecipes(filtered);
//       })
